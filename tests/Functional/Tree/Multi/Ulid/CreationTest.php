...
class CreationTest extends AbstractFunctionalTreeTestCase
{
    ...
    public function makeRoot(): void
    {
        ...
        static::assertEquals(26, strlen($model->tree_id));
    ...
    public function appendTo(): void
    {
        ...
        static::assertEquals($root->tree_id, $child1->tree_id);
        static::assertEquals($root->tree_id, $child2->tree_id);
    ...
    public function insertBeforeAndAfter(): void
    {
        ...
        foreach ($children as $child) {
            static::assertEquals($root->tree_id, $child->tree_id);
        }
    }
}
